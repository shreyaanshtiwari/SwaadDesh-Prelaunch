        ...
        <footer className="bg-[#1a0101] text-[#fdfbf7] pt-8 pb-4 border-t-[4px] border-[#d4af37]">
            <div className="container mx-auto px-4 md:px-6 max-w-7xl flex flex-col items-center text-center space-y-8 relative">
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 pt-2">
                    <a href="https://www.instagram.com/swaddesh.co" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-[#1a0101] border border-[#d4af37]/40 hover:bg-[#d4af37] hover:border-[#d4af37] flex items-center justify-center transition-all duration-300 text-[#d4af37] hover:text-[#1a0101] hover:scale-110" aria-label="Instagram" suppressHydrationWarning>
                    ...
                    <a href="https://youtube.com/@swaddesh?si=uev0zR27AM5hwc9X" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-[#1a0101] border border-[#d4af37]/40 hover:bg-[#d4af37] hover:border-[#d4af37] flex items-center justify-center transition-all duration-300 text-[#d4af37] hover:text-[#1a0101] hover:scale-110" aria-label="YouTube">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
