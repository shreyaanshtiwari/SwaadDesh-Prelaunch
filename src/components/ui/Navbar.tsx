    ...
    return (
        <nav
            className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-500 ${isScrolled
                ? 'bg-[#1a0101]/90 backdrop-blur-md border-b border-[#d4af37]/30 py-3 shadow-[0_4px_30px_rgba(0,0,0,0.5)]'
                : 'bg-transparent py-5'
                }`}
        >
            <div className="container mx-auto px-4 md:px-6 max-w-7xl flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-8 bg-black/20 px-8 py-3 rounded-full border border-[#d4af37]/20 backdrop-blur-sm">
                    <button
