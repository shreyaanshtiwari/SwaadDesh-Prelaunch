...
export const FAQ = () => {
    ...
    return (
        <Section className="!pt-2 !pb-2 lg:!pt-8 lg:!pb-8 relative border-b-[4px] border-[#d4af37]">
                ...
                <div className="space-y-4">
                    {faqs.map((faq, index) => (
                        ...
                        >
                            ...
                            >
                                <span className="font-bold text-xl text-[#4a0404] font-body tracking-wide">{faq.question}</span>
