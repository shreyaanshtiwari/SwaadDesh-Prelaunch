    ...
    return (
        <footer className="bg-[#1a0101] text-[#fdfbf7] pt-8 pb-4 border-t-[4px] border-[#d4af37]">
            <div className="container mx-auto px-4 md:px-6 max-w-7xl flex flex-col items-center text-center space-y-8 relative">
                <Image src="/logo.png" alt="SwaadDesh Logo" width={200} height={70} className="object-contain" />
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 pt-2">
                    <a href="https://www.instagram.com/swaaaddesh?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-[#1a0101] border border-[#d4af37]/40 hover:bg-[#d4af37] hover:border-[#d4af37] flex items-center justify-center transition-all duration-300 text-[#d4af37] hover:text-[#1a0101] hover:scale-110" aria-label="Instagram">
                    ...
                    <a href="https://youtube.com/@swaaddesh?si=k6L_czMdL8oHY_tP" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-[#1a0101] border border-[#d4af37]/40 hover:bg-[#d4af37] hover:border-[#d4af37] flex items-center justify-center transition-all duration-300 text-[#d4af37] hover:text-[#1a0101] hover:scale-110" aria-label="YouTube">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                        </svg>
                    </a>
                    <a href="mailto:swaaddesh111077@gmail.com" className="w-12 h-12 rounded-full bg-[#1a0101] border border-[#d4af37]/40 hover:bg-[#d4af37] hover:border-[#d4af37] flex items-center justify-center transition-all duration-300 text-[#d4af37] hover:text-[#1a0101] hover:scale-110" aria-label="Email">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="pt-3 mt-2 text-sm text-[#d4af37]/60 w-full border-t border-[#d4af37]/20 flex flex-col md:flex-row justify-between items-center gap-2 md:gap-4">
                    <p className="tracking-wide">© {new Date().getFullYear()} SwaadDesh. All rights reserved.</p>
